...
class QuizInterface:
    ...
    def get_next_question(self):
        if self.quiz.still_has_questions():
            ...
            self.canvas.itemconfig(self.question_text, text=f"You've reached the end of the quiz. Thank you for playing along. \nYou scored: {self.quiz.score}", font=("Arial", 25, "bold"))
